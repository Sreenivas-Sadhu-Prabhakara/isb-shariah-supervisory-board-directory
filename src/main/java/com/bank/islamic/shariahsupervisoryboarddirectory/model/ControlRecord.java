package com.bank.islamic.shariahsupervisoryboarddirectory.model;
...
/**
 * The BIAN control record for this service domain: "SSB Member Mandate Directory Entry".
 *
 ...
 * to its asset type (SSB Member Mandate). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "SSB Member Mandate Directory Entry";
